...
import com.test.navdemo.eventbus.RouteEvent;
import com.test.navdemo.overlay.WalkRouteOverlay;
import com.test.navdemo.util.AMapUtil;
...
public class WalkRouteActivity extends Activity implements OnMapClickListener,
    ...
    protected void onCreate(Bundle bundle) {
        ...
        init();
        mStartPoint = (LatLonPoint) getIntent().getParcelableExtra("startPoint");
        mEndPoint = (LatLonPoint) getIntent().getParcelableExtra("endPoint");
        if (mEndPoint != null) {
            setfromandtoMarker();
    ...
    public void onRouteEvent(RouteEvent event) {
        if (event != null) {
            mStartPoint = event.getmStartPoint();
            mEndPoint = event.getmEndPoint();
            setfromandtoMarker();
